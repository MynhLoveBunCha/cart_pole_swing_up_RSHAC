...
static GHAC_ctrl_swingUp controllerObj;         // Instance of model class
...
void controller_oneStep(void)
{
  ...
  // Re-enable timer or interrupt here
  // Set model inputs here
  controllerObj.rtU.X_i[0] = cart_position;
  controllerObj.rtU.X_i[1] = cart_pos_vel;
  controllerObj.rtU.X_i[2] = pend_angle_wrapped;
  controllerObj.rtU.X_i[3] = pend_ang_vel;
